...
export const WorkflowsEmpty = () => {
  ...
  return (<>
    <EmptyView message="You havent created any workflows yet. Get Started by creating your first Workflow"
      onNew={handleCreate}
    />
  </>)
};
...
export const WorkflowItem = ({ data }: { data: Workflow }) => {
  ...
  return (
    <EntityItem href={`/workflows/${data.id}`} title={data.name} subtitle={
      <>
